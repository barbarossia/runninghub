...
- **API_KEY**: 在 RunningHub 控制台"API 调用"中可获得
  - 示例：`0s2d1***********2n3mk4`

- **workflowId**: 工作流ID
  - 示例：`1980468315921559554`
  - 来源：链接末尾，如 `https://www.runninghub.cn/workflow/1980237776367083521?source=workspace`
...
{
  "apiKey": "your_api_key",
  "workflowId": "2012164403759681538",
  "nodeInfoList": [
    {
      "nodeId": "77",
      "fieldName": "video",
      "fieldValue": "api/b9ffd24e1fae8ee8e2fa0ac292ca68340b0d60dfab231ac12aa59153035db084.mp4"
    }
  ]
}
```
...
- JSON 文件一定要在自己的工作台中获得，获得途径为导出工作流API到本地
- 对于视频工作流，`fieldName` 应该是 `"video"` 而不是 `"image"`
