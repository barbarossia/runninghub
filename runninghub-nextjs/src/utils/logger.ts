...
// Convenience exports
export const logInfo = (message: string, options?: LoggerOptions) =>
	logger.info(message, options);
export const logSuccess = (message: string, options?: LoggerOptions) =>
	logger.success(message, options);
export const logWarning = (message: string, options?: LoggerOptions) =>
	logger.warning(message, options);
export const logError = (message: string, options?: LoggerOptions) =>
	logger.error(message, options);
export const logDebug = (message: string, options?: LoggerOptions) =>
