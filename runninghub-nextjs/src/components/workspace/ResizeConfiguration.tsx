...
interface ResizeConfigurationProps {
	onConfigChange?: (
		config: ReturnType<typeof useResizeConfigStore.getState>,
	) => void;
	disabled?: boolean;
	className?: string;
}
					...
					<div className="flex items-start gap-3 p-3 bg-red-50 border border-red-200 rounded-lg">
						...
						<div className="text-sm text-red-700">
							...
							<p className="text-xs mt-1">
								Original files will be permanently deleted from your file system
				...
				<div className="space-y-3 pt-2">
					...
					<div className="space-y-2">
						...
						<p className="text-xs text-gray-500">
							Videos/images will be scaled so their longest edge matches this
							value
						</p>
					</div>
					...
					<div className="space-y-2">
						...
						/>
						<p className="text-xs text-gray-500">
							Added to filename before extension (e.g.,{" "}
							<code>image_resized.jpg</code>)
						</p>
					</div>
				...
				<div className="pt-3 border-t border-gray-200">
					<div className="flex items-start gap-2 text-xs text-gray-600">
						...
						<div className="space-y-1">
							<p>
								Resize preserves aspect ratio. Example: A 720×1280 video with
								longest edge 768 will be resized to 432×768.
							</p>
							<p className="text-yellow-700">
								💡 When "Delete original" is checked, the resized file keeps the
								original name to maintain association with caption (.txt) files.
							</p>
						</div>
					</div>
				</div>
