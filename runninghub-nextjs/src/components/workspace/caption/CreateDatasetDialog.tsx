    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              A new folder will be created in the current directory with this name.
            </p>
          </div>
          ...
          <div className="text-xs text-gray-600 bg-purple-50 p-3 rounded-lg border border-purple-200">
            ...
            <p className="text-purple-700 mt-1 font-mono">{parentPath}/{datasetName || '<name>'}/</p>
          </div>
          ...
          {hasSelectedFiles && (
            <div className="text-xs text-gray-600 bg-blue-50 p-3 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 mt-1">{selectedFiles.length} file{selectedFiles.length !== 1 ? 's' : ''}</p>
            </div>
          )}
        </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleCreate} disabled={isCreating || !datasetName.trim()} className="bg-purple-600 hover:bg-purple-700">
            {isCreating ? (
              <>
