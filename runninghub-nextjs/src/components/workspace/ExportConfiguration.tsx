...
interface ExportConfigurationProps {
	onConfigChange?: (
		config: ReturnType<typeof useExportConfigStore.getState>,
	) => void;
	disabled?: boolean;
	className?: string;
}
					...
					<div className="flex items-start gap-3 p-3 bg-red-50 border border-red-200 rounded-lg">
						...
						<div className="text-sm text-red-700">
							...
							<p className="text-xs mt-1">
								Selected files will be permanently deleted from your file system
					...
					<label className="flex items-center gap-3 cursor-pointer group">
						...
						<div className="flex flex-col">
							...
							<span className="text-xs text-gray-500">
								Permanently remove files from workspace after they are
