...
export function ConsoleViewer({
	...
	const [filterLevel, setFilterLevel] = useState<"all" | LogEntry["level"]>(
		"all",
	);
	const [filterSource, setFilterSource] = useState<"all" | LogEntry["source"]>(
		"all",
	);
				...
				<div className="fixed bottom-16 left-4 z-[60]">
					<div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-blue-200 dark:border-blue-800 p-3 space-y-3 min-w-[200px]">
						<div className="space-y-1.5">
							...
							<Select
								value={filterLevel}
								onValueChange={(v) => setFilterLevel(v as typeof filterLevel)}
							>
				...
				>
					...
					<div className="flex items-center justify-between px-4 py-2 border-b border-blue-100 dark:border-blue-900 bg-blue-50/50 dark:bg-blue-950/50 backdrop-blur-sm">
						<div className="flex items-center gap-2 flex-1">
							...
							<Badge
								variant="secondary"
								className="ml-2 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs"
							>
								{logs.length} logs
							</Badge>
							{taskStatus && (
								...
								<div className="ml-auto flex items-center gap-2">
									...
									{taskStatus && (
										...
										>
											...
											{taskStatus.status}: {taskStatus.completedCount}/
											{taskStatus.totalImages}
										</Badge>
									)}
								</div>
							</div>
								...
								{filteredLogs.length === 0 ? (
									...
									filteredLogs.map((log, index) => (
										...
										>
											...
											<span className="text-[10px] text-gray-500 dark:text-gray-400 flex-shrink-0 font-mono">
												{log.timestamp}
											</span>
