...
export function ConfigurationCard({
	...
	const defaultIconBgColor =
		variant === "dark"
			? "bg-blue-500/10 group-hover/header:bg-blue-500/20"
			: "bg-blue-100";
	const defaultIconColor =
		variant === "dark" ? "text-blue-500" : "text-blue-600";
					...
					<div>
						<h3
							className={cn(
								...
								styles.title,
								variant === "dark" &&
									"group-hover/header:text-blue-400 transition-colors",
							)}
						>
							{title}
						</h3>
