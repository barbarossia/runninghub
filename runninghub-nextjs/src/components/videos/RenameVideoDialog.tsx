...
export function RenameVideoDialog({ video, isOpen, onClose, onRename }: RenameVideoDialogProps) {
  ...
  useEffect(() => {
    if (video) {
      ...
      const nameWithoutExt = video.name.substring(0, video.name.lastIndexOf('.')) || video.name;
