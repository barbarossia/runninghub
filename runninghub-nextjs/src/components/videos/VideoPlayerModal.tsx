              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <p className="font-medium capitalize text-gray-900 dark:text-gray-100">Video</p>
                  </div>

                  <div>
                    <span className="text-gray-500 text-xs">Extension</span>
                    <p className="font-medium text-gray-900 dark:text-gray-100">{video.extension?.toUpperCase() || 'N/A'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-gray-100">
                      ...
                      <span className="text-gray-500 text-xs ml-1">({video.size.toLocaleString()} bytes)</span>
                    </p>
                  </div>
                  ...
                  {video.fps ? (
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-gray-100">{video.fps} FPS</p>
                    </div>
                  ) : (
                    <div>
                      <span className="text-gray-500 text-xs">Frame Rate</span>
                  ...
                  {video.duration ? (
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-gray-100">{video.duration.toFixed(2)} s</p>
                    </div>
                  ) : null}
                </div>
              </div>
