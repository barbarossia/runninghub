...
export const useCaptionStore = create<CaptionStoreActions>()(
  persist(
    (set) => ({
      ...
      setResizePercentage: (percentage) => set({ resizePercentage: percentage }),
      ...
      toggleRenamePreserveExtension: () =>
        set((state) => ({ renamePreserveExtension: !state.renamePreserveExtension })),
      ...
      toggleConvertDeleteOriginal: () =>
        set((state) => ({ convertDeleteOriginal: !state.convertDeleteOriginal })),
